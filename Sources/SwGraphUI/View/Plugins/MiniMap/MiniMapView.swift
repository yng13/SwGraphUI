...
public struct MiniMapView<Data: Sendable>: View {
    ...
    public var body: some View {
        GeometryReader { geometry in
            ...
            // グラフ全体の Bounds と、現在の Viewport (可視領域) の両方を包含する矩形を計算
            // これにより、ビューポートがノードから遠く離れていてもミニマップ内に収まるようにする
            ...
            ZStack(alignment: .topLeading) {
                ...
                // 現在のビューポート領域
                Rectangle()
                    .stroke(strokeColor, lineWidth: 1.5) // 線を少し太く
            ...
            .clipped()
            .background(.ultraThinMaterial) // グラスモフィズムによる高級感と視認性の両立
